...
| **macOS (Intel)** | `Vexa.MD_x.y.z_x64.dmg` | DMG 마운트 → Applications 폴더로 드래그 |
...
- **릴리스 가이드**: [docs/RELEASE_GUIDE.md](https://github.com/thewinmaker-fishwater/vexaMd/blob/main/docs/RELEASE_GUIDE.md)

---

## ⚖️ 라이선스

본 저장소는 컴파일된 인스톨러 바이너리를 호스팅합니다. 라이선스/약관은 소스 저장소를 따릅니다. 자세한 내용은 [소스 저장소의 LICENSE](https://github.com/thewinmaker-fishwater/vexaMd) 파일을 확인해 주세요.
